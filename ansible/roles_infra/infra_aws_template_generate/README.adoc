...
When creating a config, you can either have the config under the `configs/{{config}}/files/cloud_providers/ec2_cloud_template.j2`, or use the default template.
